...
$essay_args = array(
  ...
  foreach ($essayposts as $essaypost) {
    ...
    echo '<tr class="essay-'.$post_id.'">';
      echo '<td class="align-middle">'.$post_date.'</td>';
      echo '<td class="align-middle"><a href="'.get_the_permalink($post_id).'" target="_blank">'.$essaypost->post_title.'</a></td>';
      echo '<td class="align-middle text-capitalize">'.$essaypost->post_status.'</td>';
